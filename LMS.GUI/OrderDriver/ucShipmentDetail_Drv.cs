...
//            {
//                // Thay đổi: "Tất cả đang chạy" thành "Tất cả" vì bạn muốn hiện tất cả
//                new ShipmentStatusFilterItem { Value = null, Text = "— Tất cả —" },
//                new ShipmentStatusFilterItem { Value = ShipmentStatus.Pending, Text = "Chờ nhận" }, // Thêm Pending
...
//                new ShipmentStatusFilterItem { Value = ShipmentStatus.Delivered, Text = "Đã giao xong" }, // Thêm Delivered
...
//        private void Wire()
//        {
//            btnReload.Click += (s, e) => LoadShipments();
...
//                // SỬA: Dùng GetAllMine để luôn tải TẤT CẢ chuyến (kể cả quá khứ và pending)
//                // Theo yêu cầu mới: "dgv của ucShipmentDetail_Drv vẫn hiện tất cả chuyến"
//                data = _svc.GetAllMine(DriverId, from, to, st);

//                // Lọc ngày (Không cần dùng .Where nữa vì GetAllMine đã có filter ngày)
...
//                {
//                    // Tự động chọn dòng đầu tiên để cập nhật Labels
...
//        /// <summary>
//        /// Cập nhật các Label trong khung chi tiết với định dạng "Tiêu đề: Dữ liệu"
//        /// </summary>
...
//                // THÔNG TIN BỔ SUNG: Sẽ hiển thị 'N/A' nếu Service chưa cung cấp dữ liệu
...
//        {
//            // Chỉ cần đảm bảo có chuyến hàng được chọn để mở popup quản lý
...
//            // Mở ucShipmentRun_Drv (màn hình thao tác) trong một Form popup
...
//        /// <summary>
//        /// Helper để dịch Status Enum sang Tiếng Việt
//        /// </summary>
