//// LMS.GUI/OrderCustomer/ucOrderCreate_Cus.cs
...
//            if (cmbOriginZone.SelectedItem == null) { err.SetError(cmbOriginZone, "Chọn vùng gửi"); ShowTip(cmbOriginZone, "Hãy chọn vùng gửi"); ok = false; }
//            if (cmbOriginWarehouse.SelectedItem == null) { err.SetError(cmbOriginWarehouse, "Chọn kho gửi"); ShowTip(cmbOriginWarehouse, "Hãy chọn kho gửi"); ok = false; }
//            if (cmbDestZone.SelectedItem == null) { err.SetError(cmbDestZone, "Chọn vùng nhận"); ShowTip(cmbDestZone, "Hãy chọn vùng nhận"); ok = false; }
//            if (cmbDestWarehouse.SelectedItem == null) { err.SetError(cmbDestWarehouse, "Chọn kho nhận"); ShowTip(cmbDestWarehouse, "Hãy chọn kho nhận"); ok = false; }
...
//            {
//                err.SetError(cmbDestWarehouse, "Kho nhận phải khác kho gửi");
//                ShowTip(cmbDestWarehouse, "Kho nhận phải khác kho gửi");
//                ok = false;
//            }
...
//            {
//                err.SetError(txtPickupAddress, "Nhập địa chỉ lấy hàng");
//                ShowTip(txtPickupAddress, "Vui lòng nhập địa chỉ lấy hàng");
//                ok = false;
//            }
...
//            if (!btnNext.Enabled)
//            {
//                ShowTip(btnNext, "Hãy bấm Tính tiền trước khi tiếp tục");
//                return;
//            }
//            if (!ValidateAll())
//            {
...
//        private void ShowTip(Control c, string message)
//        {
//            tip.RemoveAll();
//            tip.IsBalloon = true;
//            tip.ToolTipIcon = ToolTipIcon.Warning;
//            tip.ToolTipTitle = "Thiếu thông tin";
//            tip.Show(message, c, c.Width / 2, c.Height, 2500);
//            c.Focus();
//        }

//        private void OrderCreateCusFieldTips()
//        {
//            //AttachHtmlTip(cmbOriginZone, "<b>Họ tên</b>: ghi đầy đủ, có dấu.");
//            //AttachHtmlTip(cmbOriginWarehouse, "<b>Tài khoản</b>: 8–16 ký tự (chữ/số/_).");
//            //AttachHtmlTip(cmbDestZone, "<b>Mật khẩu</b> ≥ 6 ký tự.<br/>Có thể bật <i>Hiện mật khẩu</i> để xem.");
//            //AttachHtmlTip(cmbDestWarehouse, "Nhập lại <b>mật khẩu</b> giống ô trên.");
//            //AttachHtmlTip(txtPickupAddress, "Địa chỉ: Số nhà, đường, phường/xã, quận/huyện, tỉnh/thành.");
//            //AttachHtmlTip(dtpDesiredTime, "<b>SĐT</b>: 9–15 chữ số (0–9).");
