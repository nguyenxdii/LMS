...
//using LMS.DAL; // Cần cho LogisticsDbContext
...
//namespace LMS.GUI.OrderAdmin // Đặt đúng namespace
//{
//    public partial class ucDriverPicker_Ad : UserControl
//    {
//        // === Định nghĩa Sự kiện ===
//        /// <summary>
//        /// Sự kiện được kích hoạt khi người dùng chọn một tài xế và nhấn nút Chọn.
//        /// </summary>
//        public event Action<int> DriverSelected; // Dùng Action<int> cho gọn

//        // === Biến cho Sort ===
//        private DataGridViewColumn _sortedColumn = null;
//        private SortOrder _sortOrder = SortOrder.None;

//        public ucDriverPicker_Ad()
//        {
//            InitializeComponent();
...
//        {
//            var g = dgvDrivers; // Đảm bảo tên DataGridView là dgvDrivers
//            g.Columns.Clear();
...
//            // Header Style (Giống các grid khác)
...
//            g.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(64, 64, 64);
//            g.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
//            g.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
//            g.ColumnHeadersHeight = 36;

//            // Cell Style (Giống các grid khác)
//            g.DefaultCellStyle.Font = new Font("Segoe UI", 10);
//            g.DefaultCellStyle.SelectionBackColor = Color.FromArgb(220, 223, 226); // Xám nhạt
...
//                        .Where(d => d.IsActive) // Chỉ lấy tài xế đang hoạt động
//                        .OrderBy(d => d.FullName) // Sắp xếp theo tên
//                        .Select(d => new
//                        {
//                            d.Id,
//                            d.FullName,
...
//                }
//                ResetSortGlyphs(); // Xóa mũi tên sort
//            }
//            catch (Exception ex)
//            {
...
//        {
//            btnSelect.Click += BtnSelect_Click;   // Nút Chọn
//            btnCancel.Click += BtnCancel_Click;   // Nút Hủy
//            dgvDrivers.ColumnHeaderMouseClick += dgvDrivers_ColumnHeaderMouseClick; // Sort
//        }
...
//        {
//            if (dgvDrivers.CurrentRow != null && dgvDrivers.CurrentRow.Cells["Id"].Value != null)
//            {
//                if (int.TryParse(dgvDrivers.CurrentRow.Cells["Id"].Value.ToString(), out int selectedId))
//                {
//                    // Kích hoạt sự kiện và truyền ID ra ngoài
...
//        {
//            // Đóng form cha mà không làm gì cả
//            this.FindForm()?.Close();
//        }
...
//        {
//            var list = dgvDrivers.DataSource as IEnumerable<object>; // Kiểu dữ liệu là anonymous
...
{
    public partial class ucDriverPicker_Ad : UserControl // Sửa tên class nếu cần
    {
        ...
        public ucDriverPicker_Ad() // Sửa tên constructor nếu cần
        {
            InitializeComponent();
            this.Load += UcDriverPicker_Admin_Load;
        }
