...
//        // THÊM: KHAI BÁO CÁC HÀM TỪ USER32.DLL ĐỂ DI CHUYỂN FORM
//        [DllImport("user32.dll")]
//        public static extern int SendMessage(IntPtr hWnd, int Msg, int wParam, int lParam);
//        [DllImport("user32.dll")]
//        public static extern bool ReleaseCapture();

//        // Constants cho Message
...
//            // Gán sự kiện MouseDown cho Panel để di chuyển Form
//            if (pnlTop != null) // Giả định tên Panel là pnlTop
//            {
...
//        {
//            // Logic cho phép kéo Form khi nhấn chuột trái vào Panel
