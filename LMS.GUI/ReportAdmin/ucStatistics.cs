...
//// ====== ALIAS DTO ======
//// RDLC detail DTOs
//using ShipmentDetailDto = LMS.BUS.Dtos.ShipmentDetailDto1;         // tên lớp bạn đang dùng trong dự án
...
//// NẰM TRONG ChartDataPoint (lớp lồng)
...
//            {
//                // Dùng Brushes của WPF để tránh mơ hồ với System.Drawing
...
//        {
//            // Lấy về kiểu nào cũng “hợp thức hóa” sang DTO đúng của RDLC
//            var raw = _statsSvc.GetRevenueOverTime(from, to); // có thể là List<TimeSeriesDataPoint> hoặc List<ChartDataPoint.TimeSeriesDataPoint>
//            var rows = raw?.Select(x => new TimeSeriesDataPoint
//            {
//                Date = x.Date,
//                Value = x.Value
//            }).ToList();
...
//        private List<OrderStatusDetailDto> GetOrderDetails(DateTime from, DateTime to)
//        {
//            var list = new List<OrderStatusDetailDto>();
...
//                {
//                    list.Add(new OrderStatusDetailDto
//                    {
//                        OrderNo = o.OrderNo,
...
//        private List<RevenueDetailDto> GetRevenueDetails(DateTime from, DateTime to)
//        {
//            var list = new List<RevenueDetailDto>();
//            using (var db = new LogisticsDbContext())
//            {
//                var orders = db.Orders
//                    .Include(o => o.Customer)
...
//                foreach (var o in orders)
//                {
//                    list.Add(new RevenueDetailDto
//                    {
//                        OrderNo = o.OrderNo,
//                        CustomerName = o.CustomerName,
//                        TotalFee = o.TotalFee,
//                        DeliveredAt = o.CreatedAt // nếu muốn ngày giao thực, map sang Shipment.DeliveredAt
//                    });
//                }
//            }
//            return list;
...
//        {
//            // Chuẩn hóa về DTO đúng cho RDLC
//            var raw = _statsSvc.GetRevenueOverTime(from, to);
//            var summaryData = raw?.Select(x => new TimeSeriesDataPoint { Date = x.Date, Value = x.Value }).ToList();
...
//                        StatusText = s.Status.ToString(),
//                        CompletedAt = s.DeliveredAt,
//                        Fee = s.Order != null ? s.Order.TotalFee : (decimal?)null
//                    })
//                    .ToList();
